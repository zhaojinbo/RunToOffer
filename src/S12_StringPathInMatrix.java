public class S12_StringPathInMatrix {
    //回溯法解决
    ...
    /**
     * 以第rowIndex和colIndex位置处的字符为起点能够找到一条路径
     * 与字符串str以strIndex位置为起点，后面字符组成的子字符串完全匹配
     *
     * @param data
     * @param rowIndex
     * @param colIndex
     ...
     * @return
     */
    private static boolean hasPathCore(char[][] data, int rowIndex, int colIndex,
